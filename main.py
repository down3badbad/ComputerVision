...
parser.add_argument('--mode', help='the execution mode, argument:\n"pretrained" for testing using our pretrained model,\n"training" for train again', type=str, default="pretrained")
...
if mode == "training":
    ...
    pretrained_model_path = "./bestmodel/pretrained_model.pt"
    load_parameters(model=model, path=pretrained_model_path)
